/* ============================================================
   ChromeWindow — simplified Chrome browser frame (dark, macOS).
   No dependencies, no assets — inline styles + inline SVG.
   Wrap page content in <ChromeWindow> to get the tab bar + URL bar.
   ============================================================ */
